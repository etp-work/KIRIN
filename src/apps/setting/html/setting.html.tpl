<div class="setting">
    <form class="form-horizontal" role="form">
        <div class="form-group">
            <label class="col-lg-2 col-md-2 col-sm-2 control-label">Workspace</label>
        ...
        <div class="form-group">
            <label class="col-lg-2 col-md-2 col-sm-2 control-label">Tomcat</label>
            <div class="input-group col-lg-10 col-md-10 col-sm-10">
        ...
        <div class="form-group">
            <label class="col-lg-2 col-md-2 col-sm-2 control-label">TestServer</label>
            <div class="input-group col-lg-10 col-md-10 col-sm-10">
